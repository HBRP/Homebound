...
CREATE TABLE IF NOT EXISTS Character.Tattoos
(
    CharacterTattooId INTEGER GENERATED BY DEFAULT AS IDENTITY,
    CharacterId INTEGER NOT NULL,
    Tattoos JSONB NOT NULL
);
...
CREATE TABLE IF NOT EXISTS Character.CallSign
(
    CharacterCallSignId INTEGER GENERATED BY DEFAULT AS IDENTITY,
    CharacterId INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS Groups.BlipSubscription
(
    GroupBlipSubscriptionId INTEGER GENERATED BY DEFAULT AS IDENTITY,
    GroupId INTEGER NOT NULL,
    BlipColor INTEGER NOT NULL,
    BlipGroupId INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS Groups.Alerts
(
    GroupAlertId INTEGER GENERATED BY DEFAULT AS IDENTITY,
    GroupAlertName VARCHAR(64) NOT NULL
);

CREATE TABLE IF NOT EXISTS Groups.AlertSubscriptions
(
    GroupAlertSubscriptionId INTEGER GENERATED BY DEFAULT AS IDENTITY,
    GroupAlertId INTEGER NOT NULL,
    GroupId INTEGER NOT NULL
);
...
CREATE TABLE IF NOT EXISTS Storage.StorableItemTypes
(
    StorableItemTypesId INTEGER GENERATED BY DEFAULT AS IDENTITY,
    StorageTypeId INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS Item.Attachments
(
    ItemAttachmentId INTEGER GENERATED BY DEFAULT AS IDENTITY,
    ItemId INTEGER NOT NULL,
    WeaponItemId INTEGER NOT NULL,
    ItemAttachmentHash INTEGER NOT NULL
);
...
CREATE TABLE IF NOT EXISTS Blip.Groups
(
    BlipGroupId INTEGER GENERATED BY DEFAULT AS IDENTITY,
    BlipGroupName VARCHAR(32) NOT NULL
);
...
(
    ...
    RequiredLicenseTypeId INTEGER NOT NULL DEFAULT(0)
);
