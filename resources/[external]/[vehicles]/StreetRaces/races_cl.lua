...
exports["em_commands"]:register_command_no_perms("race_clear", function(source, args, raw_command)
...
end, "Leave a race or clear the screen of race points.")

exports["em_commands"]:register_command_no_perms("race_record", function(source, args, raw_command)

    -- Clear waypoint, cleanup recording and set flag to start recording
    SetWaypointOff()
    cleanupRecording()
    raceStatus.state = RACE_STATE_RECORDING
    Citizen.CreateThread(recording_loop)

end, "Begin recording a race. Be sure to set waypoints!")

exports["em_commands"]:register_command_no_perms("race_save", function(source, args, raw_command)
...
end, "Save a race you've recorded", {{ name = "name", help = "Name your race"}})

exports["em_commands"]:register_command_no_perms("race_list", function(source, args, raw_command)

    TriggerServerEvent('StreetRaces:listRaces_sv')

end, "List any races you've saved")

exports["em_commands"]:register_command_no_perms("race_load", function(source, args, raw_command)
...
end, "Load a race you've saved")

exports["em_commands"]:register_command_no_perms("race_start", function(source, args, raw_command)
...
end, "Start a race!", {{ name = "Amount", help = "Amount to get into race."}, { name = "Race Delay", help = "Optional. Time before the race starts proper."}})

exports["em_commands"]:register_command_no_perms("race_cancel", function(source, args, raw_command)
