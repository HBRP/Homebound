...
-- Commands
exports["em_commands"]:register_command("cctv", function(source, args, raw)
...
local function back_space_check()
...
local function next_camera_check()
...
local function camera_rotate_check()
...
local function previous_camera_check()
...
local function scaleform_timecycle()
...
local function controls_scaleform()
	if scaleformState == "CAMERA_READY" then
