...
function trigger_server_callback(event, callback, ...)
    ...
    TriggerServerEvent("em_dal:server_callback", event, callback_event.callback_id, ...)
...
RegisterNetEvent("em_dal:server_callback:response")
AddEventHandler("em_dal:server_callback:response", function(callback_id, ...)
