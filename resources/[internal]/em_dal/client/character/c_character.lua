...
function get_target_character_id(target)
    ...
    trigger_server_callback("em_dal:get_player_character_id", function(character_id)
...
function get_target_character_id_batch(targets)
    ...
    trigger_server_callback("em_dal:get_player_character_id_batch", function(character_ids)
...
function get_server_id_from_character_id(character_id)
    ...
    trigger_server_callback("em_dal:get_server_id_from_character_id", function(server_id)
...
function is_character_id_in_radius_async(callback, character_id, radius)
    ...
    trigger_server_callback("em_dal:is_character_id_in_radius", callback, character_id, radius)
...
function create_character(character)
    ...
    trigger_server_callback("em_dal:create_character", 
...
function delete_character(character_id)
    ...
    trigger_server_callback("em_dal:delete_character", function() end, character_id)
...
function get_all_characters()
    ...
    trigger_server_callback("em_dal:get_all_characters", function(all_characters)
...
function load_character(character_id)
    ...
    trigger_server_callback("em_dal:get_character_info", function(retreived_character)

        loaded_character = retreived_character
        TriggerEvent("em_dal:character_loaded")
