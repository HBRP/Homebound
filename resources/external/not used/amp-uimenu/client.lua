callbackData = nil
RegisterNetEvent('amp-uimenu:createMenu')
AddEventHandler('amp-uimenu:createMenu', function(myMenu, cb)
    callbackData = nil
    SendNUIMessage({
        action = "show",
        menu = myMenu
...
RegisterNetEvent('amp-uimenu:closeMenu')
AddEventHandler('amp-uimenu:closeMenu', function()
    SendNUIMessage({
        action = "close"
    })
...
RegisterCommand("multimenutest", function()
    TriggerEvent("amp-uimenu:createMenu", myMultiMenu, function(value)
...
RegisterCommand("hovermenutest", function()
    TriggerEvent("amp-uimenu:createMenu", myHoverMenu, function(value)
