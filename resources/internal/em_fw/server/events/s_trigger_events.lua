...
register_server_callback("em_fw:trigger_event_for_character", function(source, callback, event, character_id, args)
...
register_server_callback("em_fw:trigger_proximity_event", function(source, callback, event, distance, args)
