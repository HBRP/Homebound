...
register_server_callback("em_fw:get_storage", get_storage)
register_server_callback("em_fw:give_item", give_item)
register_server_callback("em_fw:remove_item", remove_item)
