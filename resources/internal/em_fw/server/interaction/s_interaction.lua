...
register_server_callback("em_fw:get_nearby_interaction_points", function(source, callback, x, y, z)
...
register_server_callback("em_fw:get_all_interaction_props", function(source, callback)
...
register_server_callback("em_fw:get_nearby_interaction_peds", function(source, callback, x, y, z)
