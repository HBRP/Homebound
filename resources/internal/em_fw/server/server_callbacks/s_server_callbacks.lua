...
local function handle_callback(source, callback_id, callback, args)
    ...
    function(...) 
        ...
        TriggerClientEvent("em_fw:server_callback:response", source, callback_id, ...)

    end, table.unpack(args))

end

RegisterServerEvent('em_fw:server_callback')
AddEventHandler('em_fw:server_callback', function(event, callback_id, ...)
