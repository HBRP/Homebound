...
register_server_callback("em_fw:get_nearby_teleporter_points", function(source, callback, x, y, z)
...
register_server_callback("em_fw:get_teleporter_options", function(source, callback, teleporter_point_id)
