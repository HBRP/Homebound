register_server_callback("em_dal:get_vehicle_storage", function(source, callback, plate, location)
...
register_server_callback("em_dal:get_vehicle_storage_id", function(source, callback, plate, location)
