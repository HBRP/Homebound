...
register_server_callback("em_dal:get_emote_keybinds", function(source, callback, character_id)
...
register_server_callback("em_dal:update_emote_keybinds", function(source, callback, character_id, emote_number, emote)
