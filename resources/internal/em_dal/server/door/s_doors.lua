...
register_server_callback("em_dal:get_nearby_doors", function(source, callback, character_id, x, y, z)
...
register_server_callback("em_dal:toggle_door", function(source, callback, door_location_id)
