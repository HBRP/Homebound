...
exports["em_fw"]:register_server_callback("em_store_robbery:finished_robbing_store", function(source, callback, interaction_ped_id, successful)
    ...
    if found_id then
        ...
        local character_id = exports["em_fw"]:get_character_id_from_source(source)
        local storage_id   = exports["em_fw"]:get_character_storage_id_from_character_id(character_id)
        ...
        end, character_id, storage_id, item_id, -1, -1)
